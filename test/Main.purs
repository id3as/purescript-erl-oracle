...
import Erl.Oracle.AvailabilityDomain (AvailabilityDomain, defaultListAvailabilityDomainRequest, listAvailabilityDomains)
...
import Erl.Oracle.Subnet (SubnetDetails, createSubnet, defaultCreateSubnetRequest, defaultDeleteSubnetRequest, defaultListSubnetsRequest, deleteSubnet, listSubnets)
import Erl.Oracle.Types (AvailabilityDomainId, CompartmentId(..), ImageId(..), Shape(..))
import Erl.Oracle.VirtualCloudNetwork (VcnDetails, createVcn, defaultCreateVcnRequest, defaultDeleteVcnRequest, defaultListVcnsRequest, deleteVcn, listVcns)
